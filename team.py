...
def make_random_team(num):
	...
	skipped_moves = ['BIDE','COUNTER','DISABLE','DOUBLEEDGE','DRAGONRAGE','DREAMEATER','FOCUSENERGY','HAZE','HIGHJUMPKICK','HYPERBEAM','JUMPKICK','LIGHTSCREEN','MIMIC','MINIMIZE','MIRRORMOVE','MIST','PSYWAVE','RAGE','REFLECT','SEISMICTOSS','SONICBOOM','STRUGGLE','SUPERSONIC','TRANSFORM','SKULLBASH','NIGHTSHADE','SUBSTITUTE','WHIRLWIND','ROAR']
